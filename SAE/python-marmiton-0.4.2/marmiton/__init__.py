...
class Marmiton(object):
	...
	def get(cls, uri):
		...
		#ajout des images des ingredients
		images = soup.find_all('div', class_='RCP__sc-vgpd2s-6')
		...
		for div in images:
			...
			#mettre les data-src dans le data["images_ingredients"]
			
			for img in img_tags:
				
				listImg.append((img["data-src"], img["alt"]))
			
		#data["images_ingredients"] inclue le json des images des ingredients
		data["images_ingredients"] = listImg
